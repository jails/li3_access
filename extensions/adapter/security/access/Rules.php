...
class Rules extends \lithium\core\Object {
	...
	protected $_autoConfig = array('rules', 'defaults', 'allowAny', 'user');
	...
	protected function _init() {
		...
		$this->_rules += array(
			...
			'allowIp' => array(
				...
				'rule' => function($requester, $request, $options) {
	...
	public function check($user, $request, array $options = array()) {
		$defaults = array('rules' => $this->_defaults, 'allowAny' => $this->_allowAny);
		$options += $defaults;
